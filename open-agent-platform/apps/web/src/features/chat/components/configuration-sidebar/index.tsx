    ...
    >
      {open && (
        <div className="flex h-full flex-col">
          ...
          >
            <TabsList className="flex-shrink-0 flex-wrap justify-start gap-1 bg-transparent px-4 pt-2">
              ...
              {supportedConfigs.includes("sub_agents") && (
                <TabsTrigger value="sub_agents">Sub-Agents (Old)</TabsTrigger>
              )}
              {supportedConfigs.includes("sub_agents_config") && (
                <TabsTrigger value="sub_agents_config">Sub-Agents</TabsTrigger>
              )}
              {supportedConfigs.includes("pipeline_stages") && (
                <TabsTrigger value="pipeline_stages">Pipeline</TabsTrigger>
              )}
            </TabsList>
            ...
            <ScrollArea className="flex-1 overflow-y-auto">
              ...
              {supportedConfigs.includes("sub_agents") && (
                <TabsContent
                  ...
                  className="m-0 overflow-y-auto p-4"
                >
                  <ConfigSection title="Sub-Agents Configuration">
                    {agentId && subAgentsConfigurations[0] && (
                      <ConfigFieldSubAgents
              ...
              {supportedConfigs.includes("sub_agents_config") && (
                <TabsContent
                  value="sub_agents_config"
                  className="m-0 overflow-y-auto p-4"
                >
                  <ConfigSection title="Sub-Agents (Parallel)">
                    {agentId && subAgentsConfigConfigurations[0] && (
                      <ConfigFieldSubAgentsConfig
              ...
              {supportedConfigs.includes("pipeline_stages") && (
                <TabsContent
                  ...
                  className="m-0 overflow-y-auto p-4"
                >
                  <ConfigSection title="Pipeline Stages (Sequential)">
                    {agentId && pipelineStagesConfigurations[0] && (
                      <ConfigFieldPipelineStages
