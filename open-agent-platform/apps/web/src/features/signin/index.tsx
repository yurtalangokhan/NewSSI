...
export default function SigninInterface() {
  ...
  useEffect(() => {
    console.warn("Debug: Supabase URL:", process.env.NEXT_PUBLIC_SUPABASE_URL);
    console.warn("Debug: Anon Key Present:", !!process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY);
  }, []);
  ...
  const [showManualRedirect, _setShowManualRedirect] = useState<boolean>(false);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/");
      router.refresh(); // Ensure server components re-fetch with new auth state
    } catch (err) {
