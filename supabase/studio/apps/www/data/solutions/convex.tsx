...
const data = {
  metadata: {
    metaTitle: 'Switch from Convex to Supabase',
    metaDescription:
      'Migrate from Convex to Supabase for more control, flexibility, and the power of Postgres.',
  },
  heroSection: {
    id: 'hero',
    title: 'Moving from Convex to Supabase',
  ...
  why: {
    ...
    heading: (
      <>
        Why developers choose <span className="text-foreground">Supabase over Convex</span>
      </>
    ),
    subheading:
      'Supabase is built on standard Postgres with everything you need out of the box: auth, storage, edge functions, realtime, and vector search—all with zero lock-in. Use any ORM, connect with any tool, and build fast with AI coding assistants like Claude Code or Cursor. Your database, your data, your choice.',
    features: [
      {
        id: 'postgres-first',
        icon: Database,
      ...
      },
      {
        id: 'ultra-flexible',
        icon: Code2,
        heading: 'Ultra flexible by design',
        subheading:
          "Don't want to use our SDKs? Use any Postgres client. Don't need RLS? Don't use it. Want to use your own auth? Go ahead. Connect to external data sources with Foreign Data Wrappers. Supabase adapts to your workflow, not the other way around.",
      },
      {
        id: 'ai-optimized',
        icon: Timer,
        heading: 'Ready to move fast with AI',
        subheading:
          'Perfect for teams using Claude Code, Cursor, or other AI tools. Declare your schemas in code and deploy them to your project. Generate types on the fly.',
      },
      {
        id: 'analytics-etl',
        icon: ArrowRight,
  ...
  platform: {
    ...
    title: (
      <>
        A complete backend platform with <span className="text-foreground">zero lock-in</span>
      </>
    ),
    subheading:
      "Standard Postgres plus auth, storage, functions, and real-time. Use what you need, skip what you don't.",
    features: [
      {
        id: 'database',
        title: 'Database',
  ...
  securitySection: {
    ...
    subheading: 'Supabase is built with security at its core.',
    features: [
      {
        icon: ShieldCheck,
        heading: 'SOC 2 Type II',
        subheading: 'Certified compliant with industry security standards.',
      },
      {
        icon: Lock,
        heading: 'Row Level Security',
        subheading: 'PostgreSQL native RLS policies protect your data at the database level.',
      },
      {
        icon: Database,
        heading: 'Encrypted at rest',
        subheading: 'All data is encrypted at rest and in transit.',
      },
    ],
    cta: {
  ...
  ctaSection: {
    ...
    title: (
      <>
        Start building with Supabase and{' '}
        <span className="text-foreground">unlock the power of Postgres</span>
      </>
    ),
    primaryCta: {
      label: 'Get started',
