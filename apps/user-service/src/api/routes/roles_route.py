...
async def create_role(
    ...
    role = await repo.create(name=name, description=description, permissions=permissions, is_builtin=False)
    return {"name": role.name, "description": role.description, "permissions": role.permissions, "is_builtin": role.is_builtin}
