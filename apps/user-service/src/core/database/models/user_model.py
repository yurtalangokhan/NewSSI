...
class UserModel(Base):
    ...
    settings: Mapped["UserSettingsModel | None"] = relationship("UserSettingsModel", back_populates="user", uselist=False, lazy="selectin")
    api_keys: Mapped[list["ApiKeyModel"]] = relationship("ApiKeyModel", back_populates="user", lazy="selectin")
    sessions: Mapped[list["SessionModel"]] = relationship("SessionModel", back_populates="user", lazy="selectin")
    audit_logs: Mapped[list["AuditLogModel"]] = relationship("AuditLogModel", back_populates="user", lazy="selectin")
