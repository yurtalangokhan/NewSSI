      ...
      <Modal.Content className="max-w-lg">
        ...
        <div className="space-y-4 py-2">
          <div className="space-y-1">
            <Text size="sm" weight="medium">Provider</Text>
            <InputSelect
              value={providerType}
          ...
          <div className="space-y-1">
            <Text size="sm" weight="medium">API Key</Text>
            <input
              type="password"
              className="w-full rounded border border-input bg-background px-3 py-2 text-sm"
              placeholder="sk-..."
          ...
          <div className="space-y-1">
            <Text size="sm" weight="medium">Base URL (optional)</Text>
            <input
              className="w-full rounded border border-input bg-background px-3 py-2 text-sm"
          ...
          {isAzure && (
            <>
              <div className="space-y-1">
                <Text size="sm" weight="medium">API Version</Text>
                <input
                  className="w-full rounded border border-input bg-background px-3 py-2 text-sm"
              ...
              <div className="space-y-1">
                <Text size="sm" weight="medium">Deployment Name</Text>
                <input
                  className="w-full rounded border border-input bg-background px-3 py-2 text-sm"
                  placeholder="gpt-4o"
