  ...
  useEffect(() => {
    ...
    const fetchConfig = async () => {
      ...
      try {
        ...
        if (isActive) {
          setExistingOAuthConfig(null);
          setOAuthConfigError(t("openAPIAuth.oauthConfigLoadError"));
        }
      } finally {
        if (isActive) {
          setIsLoadingOAuthConfig(false);
          ...
          {({
            ...
            <Form className="flex flex-col h-full">
                  ...
                  <>
                    <div className="flex flex-col gap-4 px-2 pt-2">
                      ...
                      >
                        ...
                        <FormField.Control asChild>
                          ...
                          >
                            <InputSelect.Trigger
                              placeholder={t("openAPIAuth.selectMethod")}
                            />
                            <InputSelect.Content>
                              <InputSelect.Item
                                value="oauth"
                              ...
                              {isOAuthEnabled && (
                                <InputSelect.Item
                                  value="pt-oauth"
                                  description={t(
                                    "openAPIAuth.ptOauthDescription"
                                  )}
                                >
                                  OAuth Pass-through
                                </InputSelect.Item>
                              ...
                              <InputSelect.Item
                                value="custom-header"
                                description={t(
                                  "openAPIAuth.customHeaderDescription"
                                )}
                              >
                    ...
                    {values.authMethod === "oauth" && (
                      <section className="flex flex-col gap-4 rounded-12 bg-background-tint-00 border border-border-01 p-4">
                        ...
                        >
                          <FormField.Label>
                            {t("openAPIAuth.authorizationUrlLabel")}
                          </FormField.Label>
                          <FormField.Control asChild>
                            <InputTypeIn
                              name="authorizationUrl"
                        ...
                        >
                          <FormField.Label>
                            {t("openAPIAuth.clientSecretLabel")}
                          </FormField.Label>
                          <FormField.Control asChild>
                            <PasswordInputTypeIn
                              name="clientSecret"
              ...
              <Modal.Footer>
                ...
                >
                  {isSubmitting
                    ? t("openAPIAuth.connecting")
                    : t("openAPIAuth.connect")}
                </Button>
              </Modal.Footer>
            </Form>
          )}
