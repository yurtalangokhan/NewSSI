const en = {
  ...
  admin: {
    ...
    embeddings: {
      ...
      openPage: {
        ...
        hereLink: "here",
        modelListNote: "not all models listed will work with Onyx, since some have unique interfaces or special requirements. If in doubt, reach out to the Onyx team.",
        noteLabel: "NOTE:",
  ...
  googleCredentials: {
    ...
    step2Authenticate: "Step 2: Authenticate with Onyx",
