const en = {
  ...
  app: {
    ...
    nrf: {
      ...
      turnOffDescription:
        "You'll see your browser's default new tab page instead. You can turn it back on anytime in your Onyx settings.",
      cancelButton: "Cancel",
    ...
    craft: {
      notAllowedModal: {
        ...
        createAccountHint:
          "Luckily, you can create a new Onyx account to become an admin and craft with your own data!",
      ...
      noLlmProvidersModal: {
        ...
        description:
          "Onyx Craft requires an LLM provider to be configured, but only admins can set this up.",
        adminHint:
          "Please ask your admin to configure an LLM provider, or create a new Onyx account to become an admin yourself!",
        goBackButton: "Go Back",
        signingOutButton: "Signing out...",
        createAccountButton: "Create a new account",
      },
      upgradePlanModal: {
        ...
        weeklyLimitBody:
          "You've used all {{limit}} messages for this week. Your message limit will automatically reset at the start of each week, allowing you to continue crafting with Onyx.",
        totalLimitBody:
  ...
  admin: {
    ...
    rolesPage: {
      ...
      noRolesFoundDescription:
        "Create a service role before assigning permissions.",
    ...
    billing: {
      ...
      checkout: {
        ...
        seatsTitle: "Seats",
        seatsDescription:
          "Minimum {{count}} seat{{plural}} required for your current users and Slack accounts.",
