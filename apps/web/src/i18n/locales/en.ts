export default {
  ...
  "app": {
    ...
    "llmPopover": {
      ...
      "agentSectionTitle": "Agent Section Title",
      "defaultAgentLabel": "Default Agent Label",
    ...
    "nrf": {
      ...
      "turnOffTitle": "Turn off Onyx new tab page?",
      "turnOffDescription": "You'll see your browser's default new tab page instead. You can turn it back on anytime in your Onyx settings.",
      "cancelButton": "Cancel",
      "turnOffButton": "Turn off",
      "welcomeTitle": "Welcome to Onyx",
      "logInButton": "Log in",
    ...
    "craft": {
      "notAllowedModal": {
        ...
        "createAccountHint": "Luckily, you can create a new Onyx account to become an admin and craft with your own data!",
      ...
      "noLlmProvidersModal": {
        ...
        "description": "Onyx Craft requires an LLM provider to be configured, but only admins can set this up.",
        "adminHint": "Please ask your admin to configure an LLM provider, or create a new Onyx account to become an admin yourself!",
        "goBackButton": "Go Back",
        "signingOutButton": "Signing out...",
        "createAccountButton": "Create a new account"
      },
      "upgradePlanModal": {
        ...
        "weeklyLimitBody": "You've used all {{limit}} messages for this week. Your message limit will automatically reset at the start of each week, allowing you to continue crafting with Onyx.",
  ...
  "header": {
    ...
    "trialEndingBanner": "Your trial is ending soon - submit your billing information to continue using Onyx.",
  ...
  "appHealth": {
    ...
    "backendUnavailableDescription": "If this is your initial setup or you just updated your Onyx deployment, this is likely because the backend is still starting up. Give it a minute or two, and then refresh the page. If that does not work, make sure the backend is setup and/or contact an administrator."
  },
  "inputBar": {
  ...
  "agentViewer": {
    ...
    "defaultModelDescription": "This model will be used by Onyx by default in your chats.",
  ...
  "memories": {
    "addMemoryDescription": "Add personal note or memory that Onyx should remember.",
    ...
    "modalTitle": "Memory",
    "modalDescription": "Let Onyx reference these stored notes and memories in chats.",
  ...
  "settings": {
    ...
    "chatPreferences": {
      ...
      "referenceMemoriesDescription": "Let Onyx reference stored memories in chats.",
      "updateMemoriesLabel": "Update Memories",
      "updateMemoriesDescription": "Let Onyx generate and update stored memories.",
    ...
    "accounts": {
      ...
      "paidSubscriptionRequired": "Access tokens require an active paid subscription.",
      ...
      "revokeTokenWarning": "Onyx will no longer be able to access or search content from your {{sourceName}} account.",
      "tokenWillLoseAccess": "Any application using the token will lose access to Onyx. This action cannot be undone.",
    ...
    "connectors": {
      ...
      "disconnectConfirm1": "Onyx will no longer be able to access or search content from your {{sourceName}} account.",
      "disconnectConfirm2": "You can still continue existing sessions referencing {{sourceName}} content.",
  ...
  "agentEditor": {
    ...
    "starterMaxChars": "Conversation starter must be {{count}} characters or less",
    ...
    "graphPreviewToolsInfoWithTools": "{{tools}}{{count, plural, =0 {} other { + {{count}} more}}} will be available when this graph reaches a tool-capable step.",
    ...
    "mcpToolsSelectedCount": "Mcp Tools Selected Count",
  ...
  "newTenantModal": {
    "inviteTitle": "You have been invited to join {{count}} other teammate(s) of {{domain}}.",
    "joinApprovedTitle": "Your request to join {{count}} other users of {{domain}} has been approved.",
  ...
  "authPages": {
    ...
    "authError": {
      ...
      "cloudSupportNote": "If you continue to experience problems please reach out to the Onyx team at"
    },
    "errorDisplay": {
  ...
  "admin": {
    ...
    "licenseActivation": {
      ...
      "cancelButton": "Cancel",
      "manuallyAddDescription": "Manually add and activate a license for this Onyx instance.",
      "updatedSuccess": "License updated successfully!",
      "activatedSuccess": "License activated successfully!",
      "licenseKeyLabel": "License Key",
      "pasteHint": "Paste or attach your license key file you received from Onyx.",
    ...
    "llm": {
      ...
      "addProviderDescription": "Onyx supports both popular providers and self-hosted models.",
      ...
      "syncedModels": "Synced {{count}} model(s)",
    ...
    "mcpAuth": {
      ...
      "oauthPassThroughDescription": "Forward the user's OAuth access token used to authenticate Onyx.",
      "apiKey": "API Key",
      ...
      "nonDcrInfo": "If your server does not support DCR, you need register your Onyx instance with the server provider to obtain these credentials first. Make sure to grant Onyx necessary scopes/permissions for your actions.",
      "use": "Use",
    ...
    "embeddings": {
      ...
      "advancedForm": {
        ...
        "contextualRagCloudDisabled": "Contextual RAG disabled in Onyx Cloud",
      ...
      "updateModelBody": "We will re-index all your documents in the background so you will be able to continue to use Onyx as normal with the old model in the meantime. Depending on how many documents you have indexed, this may take a while.",
      "noteLabel": "NOTE:",
      "updateModelNote": "this re-indexing process will consume more resources than normal. If you are self-hosting, we recommend that you allocate at least 16GB of RAM to Onyx during this process.",
    ...
    "rolesPage": {
      ...
      "noRolesFoundDescription": "Create a service role before assigning permissions.",
    ...
    "connectorForm": {
      "documentAccess": {
        ...
        "publicOption": "Public",
        "publicDescription": "Everyone with an account on Onyx can access the documents pulled in by this connector",
        "syncOption": "Auto Sync Permissions",
        "syncDescription": "We will automatically sync permissions from the source. A document will be searchable in Onyx if and only if the user performing the search has permission to access the document in the source.",
    ...
    "kg": {
      ...
      "noGraph": "No graph",
      "noGraphHintPrefix": "Knowledge graph hint",
    ...
    "billing": {
      ...
      "checkout": {
        ...
        "seatsTitle": "Seats",
        "seatsDescription": "Minimum {{count}} seat{{plural}} required for your current users and Slack accounts.",
    ...
    "documentSets": {
      ...
      "downstreamLabel": "Downstream",
      "title": "Document Sets",
      "description": "allow you to group logically connected documents into a single bundle. These can then be used as a filter when performing searches to control the scope of information Onyx searches over.",
      ...
      "introDescription": "allow you to group logically connected documents into a single bundle. These can then be used as a filter when performing searches to control the scope of information Onyx searches over.",
    ...
    "bots": {
      ...
      "featureAutoAnswer": "Setup OnyxBot to automatically answer questions in certain channels.",
      "featureDocSets": "Choose which document sets OnyxBot should answer from, depending on the channel the question is being asked.",
      "featureDirectMessage": "Directly message OnyxBot to search just as you would in the web UI.",
    ...
    "discord": {
      ...
      "agentLayerLabel": "Agent layer",
      "unknownError": "An unknown error occurred",
      "pageDescription": "Connect Onyx to your Discord servers. Users can ask questions directly in Discord channels.",
    ...
    "chatPreferencesPage": {
      ...
      "keepChatHistoryDescription": "Specify how long Onyx should retain chats in your organization.",
      "forever": "Forever",
      "days": "{{count}} days",
    ...
    "performance": {
      "customAnalytics": {
        ...
        "disabledDescription": "To set up custom analytics scripts, please work with the team who setup Onyx in your team to set the",
        "pageDescription": "This allows you to bring your own analytics tool to Onyx! Copy the Web snippet from your analytics provider into the box below, and we'll start sending usage events.",
  ...
  "common": {
    ...
    "hide": "Hide",
    "question": "Question",
    "contextDocs": "{{count}} context docs",
    "subqueries": "{{count}} subqueries",
    "create": "Create",
    "save": "Save",
    "cancel": "Cancel",
    "delete": "Delete",
