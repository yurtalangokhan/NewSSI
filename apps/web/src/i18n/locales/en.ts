const en = {
  ...
  settings: {
    ...
    accounts: {
      ...
      revokeTokenWarning: "ATLAS will no longer be able to access or search content from your {{sourceName}} account.",
      tokenWillLoseAccess: "Any application using the token will lose access to ATLAS. This action cannot be undone.",
    ...
    connectors: {
      ...
      disconnectConfirm1: "ATLAS will no longer be able to access or search content from your {{sourceName}} account.",
