...
/**
 * shadcn/ui context-menu, added for the flow canvas — Langflow's edge and
 * canvas right-click menus (vendor/langflow/CustomEdges/index.tsx:102-127)
 * are built on this primitive, and it was the one part of their markup
 * with no counterpart here.
 *
 * Styled with the same semantic tokens as the rest of the canvas
 * (`popover`, `accent`, `muted-foreground`) rather than `dropdown-menu.tsx`'s
 * hardcoded neutral scale, so it follows the theme in both modes.
 */
