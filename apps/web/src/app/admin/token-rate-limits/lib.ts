...
export const insertGlobalTokenRateLimit = async (
  ...
  return await authenticatedFetch(`${API_PREFIX}/global`, {
    method: "POST",
    headers: {
...
export const insertUserTokenRateLimit = async (
  ...
  return await authenticatedFetch(`${API_PREFIX}/users`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export const insertGroupTokenRateLimit = async (
  ...
  return await authenticatedFetch(`${API_PREFIX}/user-group/${group_id}`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
