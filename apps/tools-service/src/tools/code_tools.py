...
class CodeTools(BaseToolCategory):
    ...
    def register_tools(self, mcp: Any) -> None:
        ...
        @mcp.tool()
        def run_python_file(file_path: str, args: Optional[str] = None, timeout: int = 60) -> str:
            """
        ...
        @mcp.tool()
        def run_pytest(test_path: str, args: Optional[str] = None, timeout: int = 120) -> str:
            """
        ...
        @mcp.tool()
        def start_dev_server(project_dir: str, port: int = 3000, command: str = "npm run dev") -> str:
            """
