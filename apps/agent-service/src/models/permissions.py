...
SERVICE_PERMISSIONS: list[PermissionDefinition] = [
    ...
    _permission("agent", "feedback", "Submit Agent Feedback"),
    ...
    _permission("mail_config", "create", "Create Mail Configurations"),
    _permission("mail_config", "delete", "Delete Mail Configurations"),
    _permission("mail_config", "read", "Read Mail Configurations"),
    _permission("mail_config", "send", "Send Mail With Configurations"),
    _permission("mail_config", "test", "Test Mail Configurations"),
    _permission("mail_config", "update", "Update Mail Configurations"),
