"""Add MCP provider, tool, and agent_tools tables.
...
Creates:
- mcp_provider   — MCP server configurations
- mcp_tool     — Cached tool definitions from providers
- agent_tools  — Junction table for agent-tool bindings
"""
