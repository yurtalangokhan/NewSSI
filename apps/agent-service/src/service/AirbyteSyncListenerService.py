...
class AirbyteSyncListener:
        ...
        for mapping in mappings:
            ...
            try:
                ...
                for job in new_completed:
                    ...
                    try:
                        await self._process_completed_job(ds_id, conn_id, job_id, update_graph)

                        # Update last_processed_job_id on success
                        await AirbyteMappingDB.update(ds_id, last_processed_job_id=job_id)
                        logger.info(
    ...
    async def _process_completed_job(
        ...
        """
        from service.IngestionService import _trigger_graph_rag_rebuild, update_sync_status
        ...
        if update_graph_rag:
            try:
                ...
                logger.exception("Graph RAG rebuild failed for datasource %s", datasource_id)
