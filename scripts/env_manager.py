    ...
    specs = {
        "configs": EnvFileSpec(
            ...
            variables=(
                ...
                var("KEYCLOAK_REDIRECT_URI", "Primary frontend OIDC callback URI.", "http://localhost:3000/auth/oidc/callback"),
                var("KEYCLOAK_REDIRECT_URIS", "Allowed frontend OIDC callback URIs.", "http://localhost:3000/auth/oidc/callback,http://localhost:3000/*"),
                ...
                var("KEYCLOAK_WEB_ORIGIN", "Primary frontend web origin.", "http://localhost:3000"),
                var("KEYCLOAK_WEB_ORIGINS", "Allowed frontend web origins.", "http://localhost:3000"),
        ...
        "web": EnvFileSpec(
            ...
            variables=(
                ...
                var("WEB_DOMAIN", "Public web origin.", "http://localhost:3000"),
        ...
        "agent-service": EnvFileSpec(
            ...
            variables=(
                ...
                var("TOOLS_SERVICE_URL", "Tools-service MCP URL through Kong.", "http://localhost:8000/internal/tools-service/mcp"),
                var("MCP_SERVER_URL", "Tools-service MCP URL through Kong.", "http://localhost:8000/internal/tools-service/mcp"),
        ...
        "user-service": EnvFileSpec(
            ...
            variables=(
                ...
                var("INTERNAL_SERVICE_TOKEN", "Shared service-to-service token.", internal_token),
                var("CORS_ALLOWED_ORIGINS", "Allowed CORS origins.", "http://localhost:3000"),
                var("REDIS_HOST", "Redis host for idempotency middleware.", common_host),
                var("REDIS_PORT", "Redis port for idempotency middleware.", "6379"),
                var("REDIS_DB", "Redis database index for idempotency middleware.", "0"),
                var("REDIS_PASSWORD", "Redis password for idempotency middleware.", "", allow_empty=True),
