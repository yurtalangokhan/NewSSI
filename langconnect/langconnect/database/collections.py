...
class CollectionsManager:
    ...
    async def list(
        ...
        For internal-service user, returns ALL collections.
        """
        async with get_db_connection() as conn:
            # Internal service can see all collections
            if self.user_id == "internal-service":
        ...
        for r in records:
            raw_metadata = r["cmetadata"]
            # Handle NULL, empty, or various metadata formats
            metadata = {}
    ...
    async def get(
        ...
        For internal-service user, skip owner check.
        """
        async with get_db_connection() as conn:
            # Internal service can access any collection
            if self.user_id == "internal-service":
