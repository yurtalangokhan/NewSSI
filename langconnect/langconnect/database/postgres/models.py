"""SQLAlchemy 2.0 declarative ORM models for the PostgreSQL tables.
...
class Base(DeclarativeBase):
    """Shared declarative base for all PG models."""
...
class PgEmbedding(Base):
    ...
    # ``vector`` type is managed by pgvector — we map it as Text so
    # SQLAlchemy doesn't complain; we never read/write raw embeddings via ORM.
